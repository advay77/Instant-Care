    ...
    <div className="contact-container">
      <div className="contact-card" style={{maxWidth: 420, width: '100%', margin: '0 auto', background: '#fff', borderRadius: '1.2rem', boxShadow: '0 4px 24px rgba(105,51,130,0.10)', padding: '2.5rem 2rem', display: 'flex', flexDirection: 'column', alignItems: 'stretch'}}>
        ...
        <form onSubmit={handleSubmit} style={{display: 'flex', flexDirection: 'column', gap: '1.1rem'}}>
          ...
          />
          <button type="submit" style={{background: 'linear-gradient(90deg, #693382 60%, #0D7C66 100%)', color: '#fff', border: 'none', borderRadius: '0.7rem', padding: '0.9rem 1.1rem', fontSize: '1.1rem', fontWeight: 600, cursor: 'pointer', transition: 'background 0.2s, transform 0.15s', boxShadow: '0 2px 8px rgba(49,130,206,0.08)'}}>Send Message</button>
        </form>
        {submitted && <div className="contact-success" style={{marginTop: '1rem', color: '#38a169', fontWeight: 500, textAlign: 'center'}}>Thank you for contacting us!</div>}
      </div>
      <div className="contact-info" style={{textAlign: 'center', background: 'linear-gradient(120deg, #e0eafc 0%, #cfdef3 100%)', borderRadius: '1.2rem', boxShadow: '0 4px 24px rgba(105,51,130,0.10)', padding: '2.5rem 1.5rem', marginTop: '2rem', maxWidth: 400, marginLeft: 'auto', marginRight: 'auto', position: 'relative'}}>
        ...
        <p style={{marginBottom: '0.5rem', color: '#4a5568'}}><strong>Email:</strong> <a href="mailto:advayanand77@gmail.com" style={{color: '#3182ce'}}>advayanand77@gmail.com <span style={{animation: 'dash-bounce 2.1s 0.4s infinite', color: '#3182ce', fontSize: 18, marginLeft: 4}}><i className="fas fa-user-md"></i></span></a></p>
        <p style={{marginBottom: '0.5rem', color: '#4a5568'}}><strong>Phone:</strong> <a href="tel:+919876543210" style={{color: '#3182ce'}}>+91 98765 43210</a></p>
